        ...
        <div class="grow transition-all duration-300">
            <div id="drawer-accordion-flush" data-accordion="collapse"
                ...
                <div v-for="(catalog, index) in props.catalogs" :key="index">
                    <h2 :id="'drawer-accordion-flush-heading-' + catalog.id">                        <button type="button" class="hover:bg-gray-100 flex items-center justify-between w-full py-3 px-3 rounded-lg 
